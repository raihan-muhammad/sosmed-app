...
exports.signup = catchAsync(async (req, res) => {
  ...
  transporter.sendMail({
    to: saveUser.email,
    from: "no-reply@sosmedApp.com <raihanmuhammad.dev@gmail.com>",
    subject: "Welcome to sosmedApp",
    html: `
      <!DOCTYPE html>
<html>
...
<body>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p>This password reset your token, the token will expire after one hour</p>
                                                        <table class="btn btn-primary" role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left">
    ...
    res.json({
      message: "We have sent password reset token, check your email",
    });
  });
};
